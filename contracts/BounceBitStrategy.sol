...
/**
 * @title BounceBitStrategy
 * @author LayerBTC Team
 * @notice Example strategy for BounceBit protocol integration (mocked for demo).
 */
contract BounceBitStrategy is IStrategy, AccessControlEnumerable, ReentrancyGuard {
